...
参数名称|参数说明
-------|-------
code|错误码，具体请根据错误信息定位分析<br>为9999时，为AAR包没有完成初始化，详见第二章<br>其他错误类别和错误解决方法请在高德官网查看
info|错误信息，用于开发者分析问题
detail|错误详情，可用于页面提示
...
isLongDoubleClick|Boolean|是否快速点击，间隔2s内点击返回true，超过2s点击返回false
...
dateViewStamp|yyyy-MM-dd|String|
timeViewStamp|HH:mm:ss|String|
timeStampWithHyphen|yyyy-MM-dd_HH.mm.ss|String|
dateStamp|yyyyMMdd|String|
timeStampWithoutSecond|HH:mm|String|
timeStampWithoutHour|mm:ss|String|
getTimeStampBySystemTime|yyyy-MM-dd HH:mm:ss|String|
systemTime||Long|系统时间戳
